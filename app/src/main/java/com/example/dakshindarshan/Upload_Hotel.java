...
public class Upload_Hotel extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, AdapterView.OnItemSelectedListener{
...
*/
                                    ...
                                    objectMap.put("hotelname",fullname);
                                    objectMap.put("closetiming",description_);
                                    objectMap.put("openingtime",dirtick_);
                                    objectMap.put("vegnonveg",local_);
                                    objectMap.put("service",service_);
                                    objectMap.put("language",language_);
                                    objectMap.put("contact",avilaty_);
                                    objectMap.put("ownername",price_);
                                    objectMap.put("description",guide_);
                                    objectMap.put("state",typename);
                                    objectMap.put("location",geoPoint);
                                    objectMap.put("userid",userID);

                                    objectFirebaseFirestore.collection("Hotel").document(uuid)
                                            .set(objectMap)
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    ...
                                                    alert.setMessage("Hotel Upload Sucessful");
                                    ...
                                    Toast.makeText(Upload_Hotel.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
