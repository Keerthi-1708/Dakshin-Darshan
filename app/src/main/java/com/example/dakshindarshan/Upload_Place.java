...
public class Upload_Place extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener,AdapterView.OnItemSelectedListener{
...
*/
                                    ...
                                    objectMap.put("placename",fullname);
                                    objectMap.put("description",description_);
                                    objectMap.put("district",dirtick_);
                                    objectMap.put("localarea",local_);
                                    objectMap.put("service",service_);
                                    objectMap.put("language",language_);
                                    objectMap.put("aviblity",avilaty_);
                                    objectMap.put("price",price_);
                                    objectMap.put("guidename",guide_);
                                    ...
                                    objectFirebaseFirestore.collection("Place").document(uuid)
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    ...
                                                    alert.setMessage("Place Upload Sucessful");
